...
## Javascript Assignments  [![Build Status](https://travis-ci.org/PranavYo/js-assignments.svg?branch=master)](https://travis-ci.org/PranavYo/js-assignments)
...
* Run `git clone https://github.com/PranavYo/js-assignments.git` from command line to download the repo.
...
* Edit local README.md file and update all links (just replace all occurrences of `'PranavYo'` with your account name).
...
```
* Open https://github.com/PranavYo/js-assignments-epam.git and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/PranavYo/js-assignments/builds).
